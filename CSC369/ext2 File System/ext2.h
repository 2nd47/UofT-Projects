...
#define EXT2_DOT_DIR_SIZE 12
#define EXT2_PAR_DIR_SIZE EXT2_DOT_DIR_SIZE
...
unsigned char *node_bitmap;

// Pertinent comments where they are declared
...
// img disk, img fd, inode table, group descriptor block
